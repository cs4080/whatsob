 ...
 * @author carlos
 */
@WebServlet(name = "RemoveUserCommand", urlPatterns = {"/removeuser.do"})
public class RemoveUserCommand extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String removeuser = request.getParameter("adduser");        
        ...
        User chatuser = new User(removeuser, null, null, null, null);
 
        dao.removeContact(mainuser, chatuser);
