 ...
 * @author carlos
 */
@WebServlet(name = "AddUserCommand", urlPatterns = {"/adduser.do"})
public class AddUserCommand extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        User chatuser = new User(adduser, null, null, null, null);
 
        dao.addContact(mainuser, chatuser);
        
        UserPk userpk = new UserPk(session.getAttribute("user").toString());
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(AddUserCommand.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
