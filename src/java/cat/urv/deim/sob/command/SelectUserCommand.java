 ...
 * @author carlos
 */
@WebServlet(name = "SelectUserCommand", urlPatterns = {"/selectuser.do"})
public class SelectUserCommand extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //String userChat = request.getParameter("ff");;
        String userChat = request.getParameter("adduser");
        session.setAttribute("userChat", userChat); 
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(SelectUserCommand.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
